...
public class Routes implements ApplicationRoutes {
    ...
    public void init(Router router) {  
        ...
        // Create new Picture
        ///////////////////////////////////////////////////////////////////////
        router.GET().route("/picture/new").with(PictureController.class, "pictureNew");
        router.GET().route("/picture/edit/{id}").with(PictureController.class, "pictureEdit");
        router.GET().route("/picture/groups").with(PictureController.class, "groups");
        router.GET().route("/picture/group/{id}").with(PictureController.class, "pictureGroup");
        router.GET().route("/picture/delete/{id}").with(PictureController.class, "deletePicture");
        router.GET().route("/picture/all").with(PictureController.class, "showAll");
        
        router.POST().route("/picture/uploadFinish").with(PictureController.class, "uploadFinish");
        router.POST().route("/picture/editSubmit").with(PictureController.class, "editSubmit");
        ...
        ///////////////////////////////////////////////////////////////////////
        router.GET().route("/scroll").with(ApplicationController.class, "scroll");
